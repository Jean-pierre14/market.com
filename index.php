        ...
        <div class="row p-1">
            <div class="col-md-7 pt-3">
                <div class="box bg-dark text-light">
                    ...
                    <button class="ui mt-3 button btn blue icon labeled left">Actualise <i class="icon refresh"></i></button>
                </div>
            </div>
            <div class="col-md-5 pt-3">
                <div class="box bg-primary">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="text-light"><?php print $array[0];?> <span class="text-uppercase"><?php print $array[1];?></span></h3>
                        <div class="d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-lg btn-danger">Profile <i class="fa fa-user"></i></button>
                </div>
            </div>
        </div>
        <div class="row p-3 mt-2">
            ...
            <div class="col-md-3">
                <div class="box hover bg-white shadow">
                    ...
                    <h3 class="text-danger">30 <small>Articles</small></h3>
                </div>
            </div>
            <div class="col-md-3">
                <div class="box hover bg-white shadow">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="text-primary">Chiffre d'affaire</h3>
                        <div class="border border-2 pr-2 pl-2 raduis-4 border-dark">
                            <i class="fas fa-chart-line"></i>
                        </div>
                    </div>
                    <h3 class="text-danger chiffreDaffaire">34, 000, 000 <small>Dollar</small></h3>
                </div>
            </div>
            <div class="col-md-3">
                <div class="box hover bg-white shadow">
