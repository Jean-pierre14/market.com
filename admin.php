...
<body>
    <nav
        class="navbar navbar-expand-md bg-dark navbar-dark sticky-top d-flex justify-content-between align-items-center">
                        ...
                        <div class="col-md-10">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group col-md-3 m-0 btn-group">
                                    ...
                                    <a href="admin.php"
                                        class="btn btn-sm btn-primary d-flex justify-content-between align-items-center">Retour
                            ...
                            <div class="container-fluid p-0 m-0">
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <a href="profil.php" class="btn btn-warning btn-md mt-3 text-light shadow">Mon
                                            profil</a>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="card shadow">
                        ...
                        <div class="col-md-2">
                            <?php
                                    if (isset($_POST['fonctionBTN'])) {
                                        ...
                                        if (empty($fonction)) {
                                            array_push($err, "Le fonction est vide");
                                        }
                                        if (count($err) == 0) {
