        ...
        <div class="row p-3">
            ...
            <div class="col-md-4 col-sm-12 col-lg-4">
                <?php
                    ...
                    if (isset($_POST['edit'])) {
                        ...
                        if (empty($pa)) {
                            array_push($errors, "Le Prix unitaire d'achat est vide");
                        }
                        if (empty($quantite)) {
                            array_push($errors, "La Quantite est vide");
                        }
                        if (empty($pv)) {
                            array_push($errors, "Le Prix unitaire de vente est vide");
                        }
                        ...
                        <?php
                            if (isset($_POST['monnaieBtn'])) {
                                ...
                                if (count($errors) == 0) {
                                    ...
                                    if ($sqlMoney) {
                                        array_push($success, "Modification Reussi");
                                    } else {
                                        array_push($errors, "Echec reessaie encore plus tard");
                                    }
                                }
                            }
                            include("./config/errors.php");
            ...
            <div class="col-md-8 col-sm-12 col-lg-8">
                ...
                <div class="table-responsive">
                    <div id="normal-stock">
                        <table class="table m-0 table-sm table-hover table-striped"
            ...
            <div class="col-md-4 col-lg-4 col-sm-12">
                <a href="./includes/addproduct.php"
                    class="mb-3 btn btn-sm btn-primary d-flex justify-content-between align-items-center">
                    Ajouter Produits
